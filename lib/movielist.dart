...
import 'package:listviw_navigation/detailsmovie.dart';
  ...
  Widget build(BuildContext context) {
    List movie = [
      ...
      },
      {
        ...
        // ]
        "Image":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc0MjQzOTEwMV5BMl5BanBnXkFtZTcwMzE2NTIyMw@@._V1_SX1777_CR0,0,1777,947_AL_.jpg",
      },
      {
        "Title": "The Avengers",
        "Year": "2012",
        ...
        // ]
        "Image":"https://images-na.ssl-images-amazon.com/images/M/MV5BMTc3MzQ3NjA5N15BMl5BanBnXkFtZTcwMzY5OTY3Nw@@._V1_SX1777_CR0,0,1777,999_AL_.jpg",
      },
      {
      ...
      },
      {
        ...
        // ]
        "Image":"https://images-na.ssl-images-amazon.com/images/M/MV5BNjYzNjE2NDk3N15BMl5BanBnXkFtZTgwNzEyODgxMzE@._V1_SX1500_CR0,0,1500,999_AL_.jpg",
      },
      {
        ...
        // ]
        "Image":"https://images-na.ssl-images-amazon.com/images/M/MV5BNTMyMTRjZWEtM2UxMS00ZjU5LWIxMTYtZDA5YmJhZmRjYTc4XkEyXkFqcGdeQXVyMjk3NTUyOTc@._V1_SX1777_CR0,0,1777,999_AL_.jpg",
      },
      // {
      //   "Title": "Vikings",
      //   "Year": "2013–",
    ...
    return Scaffold(
      ...
      body: ListView.builder(itemCount: movie.length,itemBuilder: (context,index){
        ...
        return Card(
          ...
          child: VStack([
            Image.network(movie[index]["Image"]),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Title: " + movie[index]["Title"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                Text("Year:" + movie[index]["Year"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                Text("Released" + movie[index]["Released"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                Text("Director:" + movie[index]["Director"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                // Text("Director: " + movie[index]["Writer"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                // Text("Language: " + movie[index]["Language"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                // Text("ImdbRating: "+movie[index]["imdbRating"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                // Text("ImbdVotes: "+movie[index]["imdbVotes"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                // Text("ImbdID: "+movie[index]["imdbID"],style: TextStyle(fontSize: 22.0,fontWeight: FontWeight.w900),),
                SizedBox(height: 10,),
                Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  // crossAxisAlignment: CrossAxisAlignment.end,,movie[index]["Image"]
                  children: [
                    TextButton(onPressed: (){
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => DetailsMovie(movie[index]["Title"],movie[index]["Year"],movie[index]["Released"],movie[index]["Director"],movie[index]["imdbRating"],movie[index]["imdbVotes"],movie[index]["Image"])),
                      );
                    }, child: Text("View More Details",style: TextStyle(color: Colors.white),).px12(),style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Colors.blue),),),
                  ],
                ),
              ],
            ),
